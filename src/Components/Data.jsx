...
export const Category = [
    {
        id: 1,
        background: <img src="./assets/Bg images/Linux.jpg" alt="Linux" height='400px' width='400px' loading='lazy'/>,
    ...
    {
        id: 2,
        background: <img src="./assets/Bg images/Code.webp" alt="Linux" height='400px' width='400px' loading='lazy'/>,
    ...
    {
        id: 3,
        background: <img className="h-[20vh] " src="./assets/Bg images/Database.jpg" alt="Linux" height='450px' width='450px' loading='lazy'/>,
    ...
    {
        id: 4,
        background: <img src="./assets/Bg images/Js.jpg" alt="Linux" height='400px' width='400px' loading='lazy'/>,
    ...
    {
        id: 5,
        background: <img src="./assets/Bg images/Devops.jpg" alt="Linux" height='400px' width='400px' loading='lazy'/>,
    ...
    {
        id: 6,
        background: <img src="./assets/Bg images/Docker.jpg" alt="Linux" height='400px' width='400px' loading='lazy'/>,
    ...
    {
        id: 7,
        background: <img src="./assets/Bg images/PHP.jpg" alt="Linux" height='400px' width='400px' loading='lazy'/>,
    ...
    {
        id: 8,
        background: <img src="./assets/Bg images/Html.jpg" alt="Linux" height='400px' width='400px' loading='lazy'/>,
    ...
    {
        id: 10,
        background: <img className="h-[20vh] "  src="./assets/Bg images/Kubernetes.jpg" alt="Linux" height='450px' width='450px' loading='lazy'/>,
    ...
    {
        id: 11,
        background: <img src="./assets/Bg images/WordPress.jpg" alt="Linux" height='450px' width='450px' loading='lazy'/>,
    ...
    {
        id: 12,
        background: <img className="h-[20vh] " src="./assets/Bg images/Cloud.jpg" alt="Linux" height='450px' width='450px' loading='lazy'/>,
